...
class Command(BaseCommand):
    help = """
        This command generates a 128 long secret key and saves it to BASE_DIR/secret.key
    ...
    def handle(self, *args, **options):
        ...
        name = options["name"] or 'secret'
        path = os.path.join(settings.BASE_DIR, f"{name}.key")
        secret = (
