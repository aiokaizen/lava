...
from lava.views.api_views import (
    ...
    change_password, maintenance
)
from lava.views.main_views import (
    home, activate_user, ResetPasswordConfirm
)
...
class TestAPIViews(TestCase):
    ...
    def setUp(self):
        ...
        self.user_detail_url = reverse(
            'user-detail', args=[self.admin_user.pk]
        )
