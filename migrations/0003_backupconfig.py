    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automatic_backup_hour_interval', models.PositiveIntegerField(default=168, help_text='The number of hours between automatic backups.', verbose_name='Automatic backup interval')),
