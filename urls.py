...
urlpatterns = [
    ...
    path('users/password/reset/confirm/<str:uid>/<str:token>', main_views.ResetPasswordConfirm.as_view(), name='user-reset-pwd-confirm'),

    path('users/update_device_id/', api_views.update_device_id, name='user-update-device-id'),
    ...
    path('api/users/<int:pk>/change_pwd', api_views.change_password, name='user-change-pwd'),
